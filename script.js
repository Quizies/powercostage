...
const prices = {
  ...
  "United States": { price: 0.1626 / 10.14 * 0.545, currency: "USD", symbol: "$" },
  "Germany": { price: 0.3951 / 10.14 * 0.545, currency: "EUR", symbol: "€" },
  "India": { price: 7.11 / 10.14 * 0.545, currency: "INR", symbol: "₹" },
  "Canada": { price: 0.12 / 10.14 * 0.545, currency: "CAD", symbol: "$" },
  "United Kingdom": { price: 0.22 / 10.14 * 0.545, currency: "GBP", symbol: "£" },
  "France": { price: 0.18 / 10.14 * 0.545, currency: "EUR", symbol: "€" },
  "Japan": { price: 25 / 10.14 * 0.545, currency: "JPY", symbol: "¥" },
  "China": { price: 0.08 / 10.14 * 0.545, currency: "CNY", symbol: "¥" },
  "Brazil": { price: 0.15 / 10.14 * 0.545, currency: "BRL", symbol: "R$" },
  "Australia": { price: 0.25 / 10.14 * 0.545, currency: "AUD", symbol: "$" },
  "South Korea": { price: 120 / 10.14 * 0.545, currency: "KRW", symbol: "₩" },
  "Russia": { price: 4 / 10.14 * 0.545, currency: "RUB", symbol: "₽" },
  "Italy": { price: 0.23 / 10.14 * 0.545, currency: "EUR", symbol: "€" },
  "Spain": { price: 0.24 / 10.14 * 0.545, currency: "EUR", symbol: "€" },
  "Mexico": { price: 1.5 / 10.14 * 0.545, currency: "MXN", symbol: "$" },
  "Saudi Arabia": { price: 0.05 / 10.14 * 0.545, currency: "SAR", symbol: "﷼" },
  "United Arab Emirates": { price: 0.08 / 10.14 * 0.545, currency: "AED", symbol: "د.إ" },
  "Turkey": { price: 1.2 / 10.14 * 0.545, currency: "TRY", symbol: "₺" },
  "South Africa": { price: 2.5 / 10.14 * 0.545, currency: "ZAR", symbol: "R" },
  "Egypt": { price: 0.5 / 10.14 * 0.545, currency: "EGP", symbol: "£" },
  "Nigeria": { price: 50 / 10.14 * 0.545, currency: "NGN", symbol: "₦" },
  "Argentina": { price: 10 / 10.14 * 0.545, currency: "ARS", symbol: "$" },
  "Pakistan": { price: 20 / 10.14 * 0.545, currency: "PKR", symbol: "₨" },
  "Indonesia": { price: 1500 / 10.14 * 0.545, currency: "IDR", symbol: "Rp" },
  "Thailand": { price: 4 / 10.14 * 0.545, currency: "THB", symbol: "฿" },
  "Vietnam": { price: 2000 / 10.14 * 0.545, currency: "VND", symbol: "₫" },
  "Philippines": { price: 10 / 10.14 * 0.545, currency: "PHP", symbol: "₱" },
  "Malaysia": { price: 0.5 / 10.14 * 0.545, currency: "MYR", symbol: "RM" }
};
